          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" name="nama_ks" class="form-control" required>
                </div>

                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" name="alamat_ks" class="form-control" required>
                </div>

                <div class="form-group">
                  <label>NO HP</label>
                  <input type="bigint" name="hp_ks" class="form-control" required>
                </div>
